...
interface TextProps {
  ...
  reverse?: boolean;
  transition?: { type?: string; stiffness?: number; damping?: number; delay?: number; duration?: number };
...
const VerticalCutReveal = forwardRef<VerticalCutRevealRef, TextProps>(
  (
    ...
    const normalizedElements: WordObject[] =
      splitBy === "characters"
    ...
    return (
      ...
      >
        ...
        {normalizedElements.map((wordObj, wordIndex, array) => {
              ...
              {wordObj.characters.map((char, charIndex) => (
                ...
                >
                  <motion.span
                    ...
                    variants={variants}
                    onAnimationComplete={
                      wordIndex === normalizedElements.length - 1 &&
